...
abstract class MyCharTokenizer extends Tokenizer {
     ...
     */
    @SuppressWarnings("checkstyle:RedundantModifier")
    public MyCharTokenizer(AttributeFactory factory, int maxTokenLen) {
        super(factory);
     ...
     * </pre>
     */
    public static org.apache.lucene.analysis.util.CharTokenizer fromTokenCharPredicate(
     ...
     * </pre>
     */
    public static org.apache.lucene.analysis.util.CharTokenizer fromSeparatorCharPredicate(
...
public final class CustomTokenizer extends MyCharTokenizer {
