...
//    private final boolean discardPunctuation;
    ...
    public CustomTokenizerFactory(IndexSettings indexSettings, Settings settings, String name) {
        super(indexSettings, settings, name);
    }

    public CustomTokenizerFactory(IndexSettings indexSettings, Environment env, String name, Settings settings) {
        super(indexSettings, settings, name);
...
//        } catch (IOException e) {
//            throw new ElasticsearchException("failed to load custom user dictionary", e);
//        }
//    }
//
//    /**
